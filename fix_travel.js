      ...
      <nav className='nav-cinematic'>
        <div className='max-w-6xl mx-auto flex justify-between items-center'>
          ...
          <div className='flex items-center gap-8'>
            <a href='/travel' className='text-mostar-dark hover:text-mostar-sky font-medium transition-colors'>规划行程</a>
            <a href='/bookmarks' className='text-mostar-dark hover:text-mostar-sky font-medium transition-colors'>我的收藏</a>
          </div>
        </div>
      </nav>
      <main className='max-w-6xl mx-auto py-20 px-6'>
        <div className='text-center mb-16'>
          <h2 className='text-7xl md:text-9xl font-display font-bold text-gradient-cinematic mb-6'>探索世界</h2>
          <p className='text-xl md:text-2xl text-mostar-stone max-w-2xl mx-auto'>定制您的完美行程，让每次出发都成为难忘的 cinematic 体验</p>
        </div>
...
;
fs.writeFileSync('src/app/travel/page.tsx', content, 'utf8');
console.log('Fixed travel/page.tsx');
